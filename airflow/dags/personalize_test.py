...
#         datasetArn='arn:aws:personalize:us-east-1:051972272913:dataset/crunch-personalize-datasetgroup/INTERACTIONS',
...
def make_update_campaign_version(**kwargs):
    ...
    response = client.update_campaign(
        campaignArn='arn:aws:personalize:us-east-1:051972272913:campaign/crunch-campaign',
